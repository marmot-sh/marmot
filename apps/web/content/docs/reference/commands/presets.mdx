...
For multi-stage workflows that chain several verb invocations together, see [Pipelines](/docs/reference/commands/pipelines) — they share the same `@<name>` sigil routing.
