...
const sharedOutput: FieldDescriptor[] = [
  {
    ...
    type: 'path',
    label: 'Output path',
    help: 'Where to write the result. Use {i} for batches.',
    placeholder: 'e.g. ./out-{i}.png',
  },
  {
    key: 'session',
    flag: 'session',
    ...
    help: 'Session name for usage filtering.',
...
const sharedCacheControl: FieldDescriptor[] = [
  {
    ...
    help: 'true = reuse cached responses; false = always re-fetch.',
  },
  {
    key: 'refresh',
    flag: 'refresh',
    type: 'bool',
    label: 'Force refresh',
    help: 'Skip cache reads but still write fresh responses.',
  },
];
...
export const MODE_FIELDS: Record<PresetMode, FieldDescriptor[]> = {
  text: [
    ...
    },
    {
      ...
      help: 'Stop generation when one of these appears.',
      placeholder: 'e.g. ###',
    },
    {
      key: 'file',
      ...
      help: 'PDF / document files attached on every call.',
      placeholder: 'e.g. ~/docs/standards.md',
    },
    {
      key: 'image',
      flag: 'image',
      ...
      help: 'Vision input files attached on every call.',
      placeholder: 'e.g. ~/refs/brand.png',
    },
    {
      key: 'schema',
      flag: 'schema',
    ...
    },
    {
      ...
      help: 'Generic key=value passthrough.',
      placeholder: 'e.g. cache_control=ephemeral',
    },
    ...sharedOutput,
  ],
  ...
  video: [
    ...
    },
    {
      ...
      help: 'First-frame conditioning, optional last-frame as 2nd entry (max 2).',
      placeholder: 'e.g. ~/frames/first.png',
    },
    {
      key: 'n',
      flag: 'n',
  ...
  search: [
    ...baseShared,
    {
      ...
      type: 'string',
      label: 'Query prefix',
      help: 'Prepended to every runtime search query.',
      placeholder: 'e.g. Acme product launches',
    },
    {
      key: 'limit',
      flag: 'limit',
      ...
      min: 1,
      label: 'Result limit',
      help: 'Max results per call (provider-capped, typically 10–100).',
    },
    {
      key: 'depth',
      flag: 'depth',
      ...
      label: 'Search depth',
      help: 'basic = fast/cheap, standard = default, deep = slower/thorough.',
    },
    {
      key: 'freshness',
      flag: 'freshness',
      ...
      help: 'Relative recency filter (day, week, month, year).',
    ...
    },
    {
      ...
      label: 'After date',
      help: 'Lower bound on result date.',
    ...
    },
    {
      ...
      label: 'Before date',
      help: 'Upper bound on result date.',
    ...
    ...sharedCacheControl,
    {
      ...
      help: 'Emit provider-native shape under `raw` instead of normalized.',
    },
    ...sharedOutput,
  ],
  ...
  scrape: [
    ...baseShared,
    {
      ...
      help: 'Default URLs scraped on every call.',
  ...
  crawl: [
    ...
    },
    {
      ...
      type: 'string',
      label: 'Instructions',
      help: 'Natural-language guidance (Tavily-only; doubles cost).',
      appliesTo: ['tavily'],
    },
    {
      key: 'includePaths',
  ...
  findall: [
    ...
    },
    {
      ...
      type: 'string',
      label: 'Entity type',
      help: 'Kind of thing being found (Parallel-only).',
      appliesTo: ['parallel'],
    ...
    },
    {
      ...
      help: 'JSON array of {name, description} predicates (Parallel-only).',
      appliesTo: ['parallel'],
    },
    {
      key: 'schema',
